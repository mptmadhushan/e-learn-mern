              ...
              <Form onSubmit={this.handleSubmit}>
                ...
                <Form.Group controlId="quiz">
                  ...
                  <Form.Control
                    type="textarea"
                    name="quiz"
                    value={this.state.course.quiz}
                    onChange={this.handleInputChange}
                    placeholder="Enter quiz here?"
                    required
                  />
                </Form.Group>
                <Form.Group controlId="answer">
                  ...
                  <Form.Control
                    as="textarea"
                    name="answer"
                    value={this.state.course.answer}
                    onChange={this.handleInputChange}
                    placeholder="What are the answers?"
                  />
                  <Form.Text id="requirements" muted>
                    Separate requirements with commas
                  </Form.Text>
                ...
                <Form.Group controlId="correctAnswer">
                  ...
                  <Form.Control
                    type="text"
                    name="correctAnswer"
                    value={this.state.course.correctAnswer}
                    onChange={this.handleInputChange}
